    ...
    <div
        ...
        <div
            ...
            <div class="flex items-center justify-between">
                <div>
                    <h3 class="text-xl font-semibold text-gray-900 dark:text-white">Form Edit Divisi</h3>
                    <p class="text-gray-500 dark:text-slate-400 text-sm mt-1">Perbarui data divisi sesuai kebutuhan
                    </p>
                </div>
            ...
            <form method="POST" action="{{ route('admin.perusahaan.update', $perusahaan) }}" class="space-y-8">
                ...
                <div class="flex items-center justify-between pt-6 border-t border-gray-200 dark:border-white/10">
                    <div class="flex items-center space-x-2 text-gray-500 dark:text-slate-400">
                        ...
                        <span class="text-sm">Pastikan semua data sudah benar sebelum memperbarui Divisi</span>
                    </div>
