    ...
    <div
        ...
        <div
            ...
            <div class="flex items-center justify-between">
                <div>
                    <h3 class="text-xl font-semibold text-gray-900 dark:text-white">Form Edit Peserta PKL</h3>
                    <p class="text-gray-500 dark:text-slate-400 text-sm mt-1">Perbarui data peserta PKL sesuai kebutuhan
                    </p>
                </div>
            ...
            <form method="POST" action="{{ route('admin.mahasiswa.update', $mahasiswa) }}" class="space-y-8">
                ...
                <div class="space-y-6">
                    <div class="flex items-center space-x-3 mb-6">
                        ...
                        <h4 class="text-lg font-medium text-gray-900 dark:text-white">Data Peserta PKL</h4>
                    </div>
                    <div class="grid grid-cols-2 gap-6">
                        <div class="space-y-2 col-span-2">
                            <x-input-label for="nama" :value="'Nama Peserta PKL *'"
                            ...
                            <div class="relative">
                                <x-text-input name="nama" id="nama" type="text" value="{{ $mahasiswa->nama }}"
                                    ...
                                    placeholder="Masukkan nama peserta PKL" required autofocus />
                            </div>
                        ...
                        <div class="space-y-2 col-span-2">
                            ...
                            <div class="relative">
                                <x-text-input name="nim" id="nim" type="text" value="{{ $mahasiswa->nim }}"
                                    class="w-full bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/20 rounded-xl px-4 py-3 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-slate-400 focus:border-indigo-400/50 focus:bg-white/10 transition-all duration-200"
                                    placeholder="Masukkan NIM atau NIS peserta PKL" required />
                            </div>
                        ...
                        <div class="space-y-2 col-span-2">
                            ...
                            <div class="relative">
                                <x-text-input name="program_studi" id="program_studi" type="text"
                                    ...
                                    class="w-full bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/20 rounded-xl px-4 py-3 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-slate-400 focus:border-indigo-400/50 focus:bg-white/10 transition-all duration-200"
                                    placeholder="Masukkan program studi atau jurusan" required />
                            </div>
                ...
                <div class="flex items-center justify-between pt-6 border-t border-gray-200 dark:border-white/10">
                    <div class="flex items-center space-x-2 text-gray-500 dark:text-slate-400">
                        ...
                        <span class="text-sm">Pastikan semua data sudah benar sebelum memperbarui data Peserta PKL</span>
                    </div>
