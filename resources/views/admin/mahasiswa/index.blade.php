<x-app-layout>
    ...
    <div
        ...
        <div class="flex items-center gap-4">
            <div>
                <h1 class="text-3xl font-bold text-gray-900 dark:text-white mb-2">Kelola Data Peserta PKL</h1>
                <p class="text-gray-900 dark:text-blue-100 text-sm">Lihat, tambah, dan kelola data peserta PKL pada Sistem
                    Informasi PKL.</p>
            </div>
        </div>
        <div class="mt-4">
                        ...
                        <td colspan="7" class="px-6 py-16 text-center">
                            <div class="flex flex-col items-center justify-center">
                                ...
                                <p class="text-gray-400 dark:text-slate-400 text-xl font-semibold mb-2">Belum ada data
                                    Peserta PKL</p>
                                <p class="text-gray-500 dark:text-slate-500 text-sm">Mulai dengan menambah peserta PKL
